# Batch 1 — Corrected SYNTH five-stage workflow
...
2. **Stage 2 seed replication:** each generator is trained independently with seeds `[42, 123, 2024]`.
...
Real-Train only
      ...
      ├── Seed 123 → Synthetic_123
      └── Seed 2024→ Synthetic_2024
```
...
```text
seed_42, seed_123, seed_2024 → mean, sd (ddof=1), "mean ± sd"
```
