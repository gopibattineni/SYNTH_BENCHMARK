# Experiment summary — Multi-seed Batch 3
...
| Datasets | 15 |
| Generators | 8 |
| Generator seeds | 55, 155, 255, 355 |
| Total generator runs | **480** |
| Split seed | 42 (fixed) |
| Test size | 0.20 |
...
python run_experiment.py --smoke          # 1 dataset × 1 generator × 4 seeds
