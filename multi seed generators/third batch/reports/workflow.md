# Batch 3 — Corrected SYNTH five-stage workflow
...
2. **Stage 2 seed replication:** each generator is trained independently with seeds `[55, 155, 255, 355]`.
...
## STAGE 2 — Synthesis (8 generators × 4 seeds)
...
Real-Train only
      ...
      ├── Seed 155 → Synthetic_155
      └── Seed 255 → Synthetic_255
      └── Seed 355 → Synthetic_355
```
...
```text
seed_55, seed_155, seed_255, seed_355 → mean, sd (ddof=1), "mean ± sd"
```
